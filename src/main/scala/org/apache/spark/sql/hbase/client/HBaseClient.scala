...
/**
  ...
  *
  * we will add more function in the future
  * LIKE:
  * {compact & split Table}
  * {}
  */
//TODO
private[hbase] trait HBaseClient {
  ...
  /** Return a [[HBaseClient]] as new session, that will share the class loader and Hive client */
  def newSession(): HBaseClient
