...
import org.apache.spark.datasources.BytesEncoder;
import org.apache.spark.datasources.JavaBytesEncoder;
import org.apache.spark.protobuf.generated.SparkFilterProtos;
import org.apache.spark.sql.datasource.hbase.Field;
import org.apache.spark.sql.hbase.ByteArrayComparable;
import org.apache.spark.sql.hbase.DynamicLogicExpression;
import org.apache.spark.sql.hbase.DynamicLogicExpressionBuilder;
    ...
    public SparkSQLPushDownFilter(DynamicLogicExpression dynamicLogicExpression,
        ...
        for (int i = 0; i < fields.len(); i++) {
            ...
            HashMap<ByteArrayComparable, String> qualifierIndexMap =
                    currentCellToColumnIndexMap.computeIfAbsent(familyByteComparable, k -> new HashMap<>());
